...
function EmptyProjectsPlaceholder({ text }: { text: string }) {
  return (
    <Card className="rounded-3xl border border-border bg-background/80 px-4 py-6">
    ...
    <>
      ...
      >
        <div className="flex items-center justify-between gap-4 pb-3">
          <div>
            <p className="text-sm font-semibold text-sidebar-foreground">Projects</p>
          </div>
          <Button
            variant="ghost"
            size="icon"
        ...
        <Tabs defaultValue="my-projects" className="flex flex-col gap-3">
          ...
          <TabsContent value="my-projects" className="mt-4 flex-1 overflow-hidden">
